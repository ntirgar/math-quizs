...
export default function RootLanding() {
	...
	return (
		<AppShell hideHeader>
			...
			<Heading size="6" mb="6" mt="2">Why This AI Works</Heading>
			<Box className="feature-grid" mb="8">
				<Card size="4" className="feature-card fc-adaptive" tabIndex={0}>
					<Heading size="4" mb="2">Adaptive Staging</Heading>
					<Text size="2">Promotion when accuracy, streak & coverage converge—no manual level selection.</Text>
				</Card>
				<Card size="4" className="feature-card fc-mistakes" tabIndex={0}>
					<Heading size="4" mb="2">Mistake Insight Engine</Heading>
					<Text size="2">Classifies misconception types to shape targeted remediation pathways.</Text>
				</Card>
				<Card size="4" className="feature-card fc-graph" tabIndex={0}>
					<Heading size="4" mb="2">Unified Attempt Graph</Heading>
					<Text size="2">Cross-operation analytics reveals mastery gradients & retention dips.</Text>
				</Card>
				<Card size="4" className="feature-card fc-privacy" tabIndex={0}>
					<Heading size="4" mb="2">Data Minimization</Heading>
					<Text size="2">Only parent email retained. Learning signals—never personal profiles.</Text>
				</Card>
			</Box>
			<Box mt="4" mb="2">
